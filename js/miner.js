$(function(){
      ...
      if (json.id == null) {
        if (method == 'mining.set_difficulty') {
          ...
          for (var i = 0; i < $('#threads').val(); i++) {
            ...
            worker = new Worker('/static/em.js');
            var now = new Date();
  ...
  $('#save').click(function(){
    ...
    location.search = '?h=' + host + '&p=' + port + '&u=' + user + '&P=' + pass + '&T=' + threads;
    return false;
  });
  const workers = [];
  var ws = null;
